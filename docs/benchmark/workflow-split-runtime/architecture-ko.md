...
- timing event collector
- GPU / VRAM snapshot collector
- Docker lifecycle summary builder
- quality comparison builder

### 3. docs / report 계층

- benchmark family docs
- problem solving specs
- latest/history assets
...
4. [settings_page.py](/mnt/c/Users/pjjpj/Desktop/openai_manga_translater/comic-translate/app/ui/settings/settings_page.py:580)는 도구 설정 저장의 중심 지점이다.
