...
Status: REJECT for v1 raw-reproducibility/speed protocol (semantic quality: unreviewed)

- Median / confidence interval: not available. Fork F16 differs from shipping F16, so Turbo4 ABBA was not started.
- Fixed-seed replay: fork F16 differs from shipping F16 in 26 of 73 responses; Turbo4 differs from both controls in 72 of 73 responses. Fork F16 and Turbo4 were each stable across their two completed structural replays. These are raw reproducibility results, not a completed semantic-quality review.
