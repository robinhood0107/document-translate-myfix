...
| 2026-08-02 | fixed-seed structural (shipping F16, fork F16, Turbo4) | REJECT | All 73 fixed-seed requests completed and all GPU releases were confirmed. Fork F16 differed from shipping F16 in 26 responses; Turbo4 differed from both controls in 72. Turbo4 ABBA was not started. Peak VRAM 11,925 MiB; host-memory and swap values were telemetry only. R3 estimate was 111.36%, so active dual residency was not run. |
