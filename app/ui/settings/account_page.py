...
class AccountPage(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        title_label = MLabel(self.tr("Sign in is Optional")).h3()
        title_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)

        description_text = self.tr(
            "Comic Translate can be used with local models or your own API keys.\n"
            "Sign in only if you want to use hosted credits and account features."
        )
