...
:run_default
echo [workflow-split-runtime] launcher=scripts\run_workflow_split_runtime_cuda13.bat
echo [workflow-split-runtime] runtime=.venv-win-cuda13
...
echo.
echo Usage:
echo   scripts\run_workflow_split_runtime_cuda13.bat
echo   scripts\run_workflow_split_runtime_cuda13.bat run [workflow_split_runtime_benchmark.py args]
echo   scripts\run_workflow_split_runtime_cuda13.bat smoke [workflow_split_runtime_benchmark.py args]
echo   scripts\run_workflow_split_runtime_cuda13.bat summary
echo   scripts\run_workflow_split_runtime_cuda13.bat open
echo.
echo Default action:
echo   Runs the Requirement 1 family suite on .venv-win-cuda13.
echo.
echo Smoke action:
